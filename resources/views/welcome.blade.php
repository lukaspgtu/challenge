    ...
    <body class="antialiased">
                        ...
                        <div class="p-6">
                            <form id="formupload">
                                <div class="flex items-center">
                                    <div class="text-lg leading-7 font-semibold">Choose a file</div>
                                </div>
                                <div class="mt-2">
                                    <input type="file" name="file" id="file" accept=".json,.xml,.csv">
                                </div>
		...
		<script>
			...
			$('#formupload').on('submit', function(e) {
				...
				const formData = new FormData($("#formupload").get(0));
